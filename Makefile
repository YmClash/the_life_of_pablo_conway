...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@rm -rf .venv
	@poetry init --no-interaction --name=a_flask_test --author=YmC
	@echo "" >> pyproject.toml
...
# This project has been generated from YmClash/python-project-template
# __author__ = 'YmC'
# __repo__ = https://github.com/YmClash/python-project-template
# __license__ = MIT